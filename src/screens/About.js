  ...
  return (
    ...
    <div className=''>
      <div className='mainAbout'>
        ...
        {/* data graphics */}
        <p className='aboutInfoSmall'>So much of the world around us is run by technology. If women are not contributing to these systems and products, bias becomes imbedded in the algorithms, data sets and designs that influence our future.</p>
